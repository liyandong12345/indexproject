package com.sc.springcgetway.filters;
 ...
 */
@Component
public class InProFilter extends ZuulFilter {

    private static final Logger logger = LoggerFactory.getLogger(InProFilter.class);
    ...
    public Object run() throws ZuulException {
        ...
        logger.info("访问进入项目LogFilter1.....method={},url={}",
